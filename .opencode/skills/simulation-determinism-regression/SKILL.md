...
description: Use when changing fixed simulation behaviour, physics algorithms, replay, baselines, numerical integration, time acceleration, random generation, or simulation tests in Cosmic Systems.
---
...
5. Compare against the committed replay/baseline with explicit tolerances.
6. Document any intentional baseline divergence, tick, variable, and reason.
