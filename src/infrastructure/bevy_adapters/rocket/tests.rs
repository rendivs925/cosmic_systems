...
mod engine_lifecycle_pipeline_tests {
    ...
    use crate::infrastructure::bevy_adapters::rocket::control::actuation_system;
...
mod ground_contact_tests {
    ...
    use crate::infrastructure::bevy_adapters::rocket::components::TerrainCollisionState;
    ...
    fn pad_app(throttle: f32, rated_thrust_kn: f32) -> App {
        ...
        let source = PlanetTerrain::earth().source;
    ...
    fn pad_hold_survives_gravity_without_sinking() {
        ...
        let (lat, lon) = ksc_terrain_coordinates();
        let h = PlanetTerrain::earth().source.height_m(lat, lon);
...
mod recovery_pipeline_tests {
    ...
    use crate::domain::value_objects::celestial_body_id::CelestialBodyId;
    use crate::infrastructure::bevy_adapters::entity_components::{PlanetComponent, PlanetTerrain};
    use crate::infrastructure::bevy_adapters::rocket::contact::resolve_ground_contact;
    ...
    use crate::infrastructure::bevy_adapters::rocket::recovery::{
...
mod stage_coordinate_pipeline_tests {
    ...
    use crate::domain::services::simulation_time::SimulationTime;
    use crate::infrastructure::bevy_adapters::rocket::propulsion::propulsion_gimbal;
...
mod render_interpolation_tests {
    use super::*;
    use crate::infrastructure::bevy_adapters::rocket::lifecycle::handle_rocket_launch_input;
    use crate::infrastructure::bevy_adapters::rocket::presentation::{
        capture_render_state, render_dynamics_state,
    };
    ...
    fn terminal_surface_states_render_the_latest_fixed_snapshot() {
        ...
        let mut app = App::new();
        app.add_systems(Update, capture_render_state);
