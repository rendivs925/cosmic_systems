...
//!
//! Visibility/LOD selection lives in [`selection`]; the telemetry snapshot lives
//! in [`metrics`].

use crate::domain::services::cube_sphere::{
    build_patch_geometry_with_stitches, direction_to_lat_lon, select_quadtree_leaves,
