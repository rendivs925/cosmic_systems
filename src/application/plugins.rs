...
use crate::infrastructure::bevy_adapters::craft::effects::update_craft_visuals;
use crate::infrastructure::bevy_adapters::craft::systems::{
    handle_craft_input, sync_craft_transform, update_craft_camera, update_craft_physics,
};
use crate::infrastructure::bevy_adapters::craft::ui::update_craft_ui;
...
use crate::infrastructure::bevy_adapters::entity_components::{
    EntryPhysicsConfig, PlanetComponent, PlanetTerrain, SolarMapCameraCommand,
};
#[cfg(not(target_arch = "wasm32"))]
...
use crate::infrastructure::bevy_adapters::rocket::environment::{
...
fn spawn_rockets_system(
    ...
    terrain_query: Query<(&PlanetComponent, &PlanetTerrain)>,
) {
