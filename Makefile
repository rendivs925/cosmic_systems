...
benchmark-quick: benchmark-prep
	...
	./benchmark/scripts/benchmark_adaptive_kepler.sh && echo "✓ Completed" || echo "⚠ Failed/timeout"
	@echo ""
	@echo "2. SIMD Optimizations:"
	./benchmark/scripts/benchmark_simd_only.sh && echo "✓ Completed" || echo "⚠ Failed/timeout"
	@echo ""
	@echo "3. Assembly Optimizations:"
	./benchmark/scripts/benchmark_assembly.sh && echo "✓ Completed" || echo "⚠ Failed/timeout"
	@echo ""
	@echo "Analysis:"
