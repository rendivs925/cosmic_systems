...
download_jpg_as_png "${RESOLUTION}_mercury.jpg" "$OUT_ROOT/mercury/albedo.png"
download_jpg_as_png "${RESOLUTION}_venus_surface.jpg" "$OUT_ROOT/venus/albedo.png"
...
download_jpg_as_png "${RESOLUTION}_venus_atmosphere.jpg" "$OUT_ROOT/venus/clouds.png"
