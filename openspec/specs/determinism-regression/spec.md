# determinism-regression Specification
...
- **THEN** the comparison uses per-variable tolerances (position: 1 mm, velocity: 1 micrometer/s, attitude: 1 microradian, mass: 1 mg) configurable via a regression config file
