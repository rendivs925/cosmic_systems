...
Defines the authoritative ephemeris used by solar-map presentation and
solar-system flight integration boundaries.
...
The system SHALL evaluate primary-body states from one versioned local NAIF
SPICE kernel set backed by a declared JPL Development Ephemeris. No consumer
SHALL maintain a separate runtime primary-body Kepler table, numerical velocity
derivative, or network ephemeris query.
